...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
      ...
      {/* Header */}
      <header className="relative bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-12 shadow-2xl overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight bg-linear-to-brr from-blue-400 to-cyan-300 bg-clip-text text-transparent">
              Alumni Dashboard
            </h1>
          ...
          <div className="flex items-center space-x-4 bg-gray-800/50 backdrop-blur-sm px-6 py-4 rounded-2xl border border-gray-700/50 shadow-lg">
            <div className="h-12 w-12 rounded-full bg-linear-to-br from-blue-600 to-cyan-500 flex items-center justify-center text-white font-bold text-lg shadow-lg">
            ...
            <div className="text-right">
              ...
              <div className="text-xs mt-1 px-3 py-1 bg-linear-to-br from-blue-600 to-cyan-500 text-white rounded-full inline-block font-medium shadow-md">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 -mt-8 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-br from-blue-500 to-cyan-400 rounded-t-2xl"></div>
            <div className="flex flex-col items-center text-center">
              <div className="h-16 w-16 rounded-full bg-linear-to-br from-blue-100 to-cyan-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          {user && user.role === "admin" && (
            <Link
              ...
              className="group relative bg-white/90 backdrop-blur-sm p-8 rounded-2xl border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-br from-green-500 to-emerald-400 rounded-t-2xl"></div>
              <div className="flex flex-col items-center text-center">
                <div className="h-16 w-16 rounded-full bg-linear-to-br from-green-100 to-emerald-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          {user && user.role === "admin" && (
            <Link
              ...
              className="group relative bg-white/90 backdrop-blur-sm p-8 rounded-2xl border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-br from-purple-500 to-violet-400 rounded-t-2xl"></div>
              <div className="flex flex-col items-center text-center">
                <div className="h-16 w-16 rounded-full bg-linear-to-br from-purple-100 to-violet-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
